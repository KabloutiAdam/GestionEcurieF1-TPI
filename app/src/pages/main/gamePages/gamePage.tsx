                        ...
                        {gameState == "endRace" && (
                            ...
                            <>
                                ...
                                <div className="grid grid-cols-[2fr_7fr] w-full h-full overflow-hidden">
                                    ...
                                    <div className="col-span-1 col-start-2 h-full overflow-auto flex flex-col justify-center items-center">
                            ...
                            <>
                                ...
                                <div className="grid grid-cols-[2fr_7fr] w-full h-full overflow-hidden">
                                    ...
                                    <div className="col-span-1 col-start-2 h-full overflow-auto flex flex-col justify-between items-center">
                                        ...
                                        {activeTab == "drivers" && (
                                            <DriverLeaderboard driverList={raceResult} isResult={false} />
                                        )}
                                        {activeTab == "teams" && (
                                            <TeamLeadearboard driverList={raceResult} />
                                        )}
